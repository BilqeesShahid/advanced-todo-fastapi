"""
Task Completed Consumer for Recurring Task Service.
...
class TaskCompletedConsumer:
    """Consumer to handle task.completed events and create next occurrences."""

    def __init__(self, database_url: str):
        """Initialize the task completed consumer."""
    ...
    async def start_consumer(self):
        ...
        logger.info("Starting task completed consumer...")
        ...
        while True:
            try:
                ...
                logger.error(f"Error in task completed consumer: {str(e)}")
                await asyncio.sleep(5)  # Wait before retrying

    def run_dev_mode(self):
        """Run in development mode without Dapr/Kafka."""
        logger.info("Running task completed consumer in development mode...")
